    ...
    for folder in [
        ...
        for directory in tqdm(directory_list):
            ...
            if 'intraimage' in folder:
                ...
                image_list = glob('../../external_data/GLySAC/%s/%s/%s_test/*_effective_image.png' % (folder, cancer_type, img_id))
            else:
                image_list = glob('../../external_data/GLySAC/GLySACByTumor/%s/test/images/*.png' % subset)
