...
parser = argparse.ArgumentParser(description='SAM2')
...
sam2 = build_sam2("sam2_hiera_l.yaml", os.path.join('./checkpoints/', "sam2_hiera_large.pt"), device = device)
