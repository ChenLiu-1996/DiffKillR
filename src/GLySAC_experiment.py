'''
This file is used to run the experiment on GLySAC dataset.
...
def run(cfg: DictConfig) -> None:
    ...
    if os.path.exists(preprocessed_data_path):
        ...
        os.system(f"python ./preprocessing/prepare_GLySAC.py \
    ...
    os.system(f"python ./preprocessing/augment_GLySAC.py \
                --patch_size {patch_size} \
    ...
    data_config = 'config/GLySAC_data.yaml'
    model_config = 'config/GLySAC_AIAE.yaml'
    reg2seg_cfg = 'config/GLySAC_reg2seg.yaml'
